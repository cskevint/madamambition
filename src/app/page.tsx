  ...
  return (
    <main className="font-sans antialiased bg-white text-black">
          ...
          <div className="md:w-1/2 flex flex-col items-start space-y-8">
            ...
            <div className="text-base text-gray-600 font-light leading-relaxed space-y-6 max-w-xl">
              <p>
                ...
                women&apos;s careers paths. She is also an Executive Coach to Trailblazing women.
                Selena has a passion for helping women succeed, which she developed from her own
                experiences as an entrepreneur, corporate, public, and non-profit work, as well as
      ...
      <section
        ...
        className="bg-brand-copper py-24 px-6 md:px-12 lg:px-24 text-white"
      >
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-20">
          ...
          <div className="lg:w-2/3 flex flex-col">
            <h3 className="text-3xl font-serif font-extrabold tracking-wide mb-10 text-brand-beige border-b border-white/10 pb-4">
              Executive Coaching
            </h3>
            <ul className="space-y-6 text-sm md:text-base font-light leading-relaxed mb-12 max-w-2xl">
              <li className="flex gap-4 items-start">
                <span className="text-brand-beige text-xl mt-[-4px]">/</span>{" "}
                <span>
                  Executive coaching for individuals who want to make a change in their work lives,
                  who seek success in their careers and to help their companies grow
                </span>
              </li>
              <li className="flex gap-4 items-start">
                <span className="text-brand-beige text-xl mt-[-4px]">/</span>{" "}
                <span>
                  Coaching services that provide you with practical skills while also bespoke
                  services to help you advance
                </span>
              </li>
              <li className="flex gap-4 items-start">
                <span className="text-brand-beige text-xl mt-[-4px]">/</span>{" "}
                <span>
                  We specialize in working with executives to help overcome current problems and
              ...
              <li className="flex gap-4 items-start">
                <span className="text-brand-beige text-xl mt-[-4px]">/</span>{" "}
                <span>
                  Our 6-month contract provides the necessary time and commitment to see real
                  results – We work one-on-one so we can focus on your specific needs and wants
                </span>
              </li>
              <li className="flex gap-4 items-start">
                <span className="text-brand-beige text-xl mt-[-4px]">/</span>{" "}
                <span>
                  We offer group support to build communities of support from different perspectives
                  to help others develop together
                </span>
              </li>
            </ul>
            <Link
      ...
      <section className="bg-white py-24 px-6 md:px-12 lg:px-24 border-y border-gray-100">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          <h2 className="text-4xl font-serif font-extrabold text-brand-brown mb-20 text-center tracking-tight uppercase">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 w-full mb-20">
            {stories.map((article) => (
              <div key={article.slug} className="flex flex-col items-center text-center group">
                ...
                <h4 className="font-serif font-bold text-brand-copper text-xl mb-4 leading-tight group-hover:text-brand-brown transition-colors">
                  {article.title}
                </h4>
      ...
      <section className="bg-brand-beige py-32 px-6 text-center border-b border-brand-darkbeige overflow-hidden relative">
        ...
        <div className="max-w-2xl mx-auto relative z-10">
          <h3 className="text-3xl font-serif font-extrabold text-brand-brown mb-6 tracking-wide">
            Join me on Facebook
          </h3>
        ...
        <div className="flex flex-col md:flex-row min-h-[400px]">
          ...
          <div className="md:w-1/3 bg-brand-nav p-16 md:p-20 text-white flex flex-col">
            ...
            <p className="font-light text-base leading-relaxed max-w-sm opacity-80">
              Sharing knowledge is powerful. Women tell their stories and career paths to empower
              you to learn about different professions. The empowerment of women and uplifting their
