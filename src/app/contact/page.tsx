    ...
    <main className="font-sans antialiased bg-white text-black">
          ...
          <div className="md:w-1/2 flex flex-col text-left space-y-8 w-full">
            ...
            <form action={handleSubmit} className="space-y-6 w-full max-w-lg">
              <div className="flex flex-col space-y-2">
                <label
                  htmlFor="name"
                  className="text-xs uppercase tracking-widest font-bold text-brand-brown"
                >
                  Name *
                </label>
                <input
      ...
      <section className="bg-brand-beige py-24 px-6 md:px-12 lg:px-24 text-center border-t border-brand-darkbeige">
        <div className="max-w-4xl mx-auto space-y-8">
          <h4 className="text-2xl font-serif text-brand-brown font-extrabold uppercase tracking-wide">
            Follow the Journey
          </h4>
          <div className="flex justify-center space-x-12">
            {["Facebook", "Instagram", "LinkedIn"].map((social) => (
              <a
                key={social}
                href="#"
                className="text-brand-copper hover:text-brand-brown font-bold uppercase text-[10px] tracking-[0.3em] transition-colors"
              >
                {social}
              </a>
            ))}
