    ...
    <main className="font-sans antialiased bg-white text-black">
      ...
      <section className="bg-white py-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto space-y-8 text-lg text-gray-800 font-light leading-relaxed">
          <p>
            Meet Selena Trotter, a savvy Executive Coach who helps women unlock their full potential
            and make great achievements in their professional lives. With a wealth of experience in
            leadership development and a unique understanding of the profound challenges facing
            women in leadership, Selena is an expert at guiding her clients through the coaching
            process, helping them to identify their strengths, set ambitious and thoughtful goals,
            and develop practical plans to achieve them.
          </p>
          <p>
            ...
            skills and abilities, learn to overcome limiting beliefs and behaviors, and develop the
            confidence and competence they need to reach total capacity. Whether you&apos;re looking
            to take your career to the next level, improve your relationships with colleagues, bring
            emotional intelligence to your colleagues, or become a more effective leader, a
            partnership with Selena can help you achieve your ambitions and unlock your best future.
          </p>
        </div>
      </section>
      ...
      <section className="bg-brand-beige py-24 px-6 md:px-12 lg:px-24 border-y border-brand-darkbeige">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-serif font-extrabold text-brand-brown border-b border-brand-darkbeige pb-4">
              My Mission
            </h3>
            <p className="text-gray-700 font-light leading-relaxed">
              ...
              seen in equal numbers within a given institution, the institution advances at a
              quicker pace.
            </p>
            <p className="text-gray-700 font-light leading-relaxed">
              It is goal of Selena to help advance the cause of women who work. Women are leaders by
              being examples to other women of what is possible when they are putting forth the
              effort to advance in their field and support younger generations alongside them.
            </p>
          </div>
          ...
          <div className="space-y-6 flex flex-col">
            ...
            <p className="text-gray-700 font-light leading-relaxed">
              ...
              need direction and guidance earlier around careers, and all women need stronger
              support networks to foster mentorship and development. In supporting one, the other
              grows.
            </p>
            <Link
              href="/contact"
      ...
      <section className="bg-white py-32 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-24">
          ...
          <div className="md:w-1/2 flex flex-col text-left space-y-8">
            <h3 className="text-4xl md:text-5xl lg:text-6xl font-serif text-brand-copper leading-tight tracking-tight">
              Let&apos;s chat
            </h3>
            <p className="text-lg text-gray-600 font-light leading-relaxed max-w-lg">
              Book a complimentary coaching call to explore if executive coaching is right for you
              now. We create community for women trail blazers, help leaders feel greater peace,
              ease and joy through our Executive Coaching programs.
            </p>
            <Link
              href="/contact"
