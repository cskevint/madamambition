      ...
      <section className="relative py-32 px-6 overflow-hidden min-h-[600px] flex items-center">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          <blockquote className="text-2xl md:text-3xl lg:text-4xl font-serif text-brand-beige italic leading-relaxed mb-8">
            ...
            long as these two wings are not equivalent in strength, the bird will not fly. Until the
            world of women becomes equal to the world of men in the acquisition of virtues and
            perfections, the world of humanity will not achieve its full capacity.&rdquo;
          </blockquote>
      ...
      <section className="bg-white py-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl mx-auto space-y-10 text-lg text-gray-800 font-light leading-relaxed">
          <p>
            ...
            exception, the presence of women is demanded. If one wing is missing then the collective
            cannot fly. It is goal of Madam Ambition to see that women are well represented in the
            labor market.
          </p>
